...
const ChatInput = () => {
  ...
  return (
    <div className="relative flex flex-col w-full">
        ...
        <AnimatePresence>
          {showPrompts && (
            <motion.div
              ...
              exit={{ height: 0, opacity: 0, overflow: 'hidden', y: 10 }}
              transition={{ duration: 0.3, ease: 'easeInOut' }}
              className="flex flex-wrap gap-1.5 justify-center pb-2.5"
            >
              {[
                ...
                <motion.button
                  ...
                  className="flex items-center space-x-1.5 px-2.5 py-1 bg-white/60 dark:bg-gray-800/60 rounded-full border border-gray-200/80 dark:border-gray-700/80 hover:bg-white dark:hover:bg-gray-800 transition-all duration-200 text-[11px] font-medium text-gray-600 dark:text-gray-300 backdrop-blur-sm shadow-sm"
      ...
      {/* Input Form with Edge Toggle */}
      <div className="relative w-full">
        {/* Quick Actions Toggle - Positioned on Top Edge */}
        <div className="absolute left-1/2 -top-3 -translate-x-1/2 z-30">
          <button
            type="button"
            onClick={() => setShowPrompts(!showPrompts)}
            className="flex items-center justify-center w-6 h-6 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700/80 rounded-full transition-all duration-300 text-gray-400 hover:text-primary-500 shadow-sm hover:shadow-md group"
